...
class LatestPostListView(ListView):
    ...
    queryset = Post.objects.filter(available=True).order_by('-created')[:16]  # Get last 6 posts
...
def ContactView(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            mail = EmailMultiAlternatives(subject, text_content, settings.EMAIL_HOST_USER, ['azerbaijangamerstv@gmail.com'])
