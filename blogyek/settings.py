...
ALLOWED_HOSTS = ['https://django-blog-main.onrender.com localhost']
...
EMAIL_HOST_USER = 'azerbaijangamerstv@gmail.com'
EMAIL_HOST_PASSWORD = 'sayh nyow podn yqtg'
EMAIL_PORT = 587
EMAIL_USE_TLS = True

if hasattr(os, 'setdefaultencoding'):
